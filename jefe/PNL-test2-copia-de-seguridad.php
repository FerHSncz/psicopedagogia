<?php
    ...
    $sql = "SELECT p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17, p18, p19, p20, p21, p22, p23, p24, p25, p26, p27, p28, p29, p30, p31, p32, p33, p34, p35, p36, p37, p38, p39, p40 FROM pnl";
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            $visualSum += $row['p1'] + $row['p2'] + $row['p3'] + $row['p4'] + $row['p5'] + $row['p6'] + $row['p7'] + $row['p8'] + $row['p9'] + $row['p10'] + $row['p11'] + $row['p12'] + $row['p13'];
            $auditivoSum += $row['p14'] + $row['p15'] + $row['p16'] + $row['p17'] + $row['p18'] + $row['p19'] + $row['p20'] + $row['p21'] + $row['p22'] + $row['p23'] + $row['p24'] + $row['p25'] + $row['p26'];
            $kinestesicoSum += $row['p27'] + $row['p28'] + $row['p29'] + $row['p30'] + $row['p31'] + $row['p32'] + $row['p33'] + $row['p34'] + $row['p35'] + $row['p36'] + $row['p37'] + $row['p38'] + $row['p39'] + $row['p40'];
        }
    }
...
<html lang="es">
    <head>
        ...
        <title>Jefe de Área | Resultado Global Modelo PNL</title>
        <!-- Estilos CSS locales -->
        ...
        <!-- Incluir la librería de Google Charts -->
              ...
              <script language = "JavaScript">
                 ...
                 function drawChart() {
                    ...
                    var options = {title: 'Test Modelo PNL'}; 
