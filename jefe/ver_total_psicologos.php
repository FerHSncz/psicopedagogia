...
<html lang="es">
    <head>
        ...
        <title>Jefe de Área | Total de Psicólogos Registrados</title>
        <!-- Estilos CSS locales -->
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse show" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="honey-alonso1.php">Honey Alonso</a>
                                ...
                                $(document).ready(function() {
                                  // Inicializar la tabla
                                    $('#tablaPsicologos').DataTable({
                                        "ajax": "get_psicologos.php", // Ruta al archivo PHP que obtiene los datos de los alumnos
                                        "columns": [
                                            { "data": "id" },
                                            { "data": "nombre" },
                                            { "data": "email" },
