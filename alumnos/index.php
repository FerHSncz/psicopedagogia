                    ...
                    <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                      <div class="accordion-body text-white">
                        <div class="list-group list-group-flush">
                          <a href="test-lyn.php" class="list-group-item list-group-item-action bg-dark text-white"><i class="fa-solid fa-pen" style="margin-right: 0.5rem;"></i>Canal de aprendizaje de preferencia</a>
                          <a href="honey-form.php" class="list-group-item list-group-item-action bg-dark text-white"><i class="fa-solid fa-pen" style="margin-right: 0.5rem;"></i>Estilos de aprendizaje (Honey Alonso)</a>
                          <a href="PNL.php" class="list-group-item list-group-item-action bg-dark text-white"><i class="fa-solid fa-pen" style="margin-right: 0.5rem;"></i>Estilos de aprendizaje (Modelo PNL)</a>
                          <a href="riesgospsicosociales.php" class="list-group-item list-group-item-action bg-dark text-white"><i class="fa-solid fa-pen" style="margin-right: 0.5rem;"></i>Cuestionario de Riesgos Psicosociales</a>
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <div class="row" style="padding: 1rem;">
          <div class="col" style="padding: 1rem;">
            <div class="card" style="width: 18rem;">
              <img src="../img/test.png" class="card-img-top" alt="Imagen-test">
              <div class="card-body">
                <h5 class="card-title">Canal de aprendizaje de preferencia</h5>
                <p class="card-text">Este test es el primer test xd</p>
                <a href="test-lyn.php" class="btn btn-primary">Iniciar test</a>
              </div>
            </div>
          </div>
          <div class="col" style="padding: 1rem;">
            <div class="card" style="width: 18rem;">
              <img src="../img/test.png" class="card-img-top" alt="Imagen-test">
              <div class="card-body">
                <h5 class="card-title">Estilos de aprendizaje (Honey Alonso)</h5>
                <p class="card-text">Este test es el segundo test xd</p>
                <a href="honey-form.php" class="btn btn-primary">Iniciar test</a>
              </div>
            </div>
          </div>
          <div class="col" style="padding: 1rem;">
            <div class="card" style="width: 18rem;">
              <img src="../img/test.png" class="card-img-top" alt="Imagen-test">
              <div class="card-body">
                <h5 class="card-title">Estilos de aprendizaje (Modelo PNL)</h5>
                <p class="card-text">Este test es el tercer test xd</p>
                <a href="PNL.php" class="btn btn-primary">Iniciar test</a>
              </div>
            </div>
          </div>
          <div class="col" style="padding: 1rem;">
            <div class="card" style="width: 18rem;">
              <img src="../img/test.png" class="card-img-top" alt="Imagen-test">
              <div class="card-body">
                <h5 class="card-title">Cuestionario de Riesgos Psicosociales</h5>
                <p class="card-text">Este test es el cuarto test xd</p>
                <a href="riesgospsicosociales.php" class="btn btn-primary">Iniciar test</a>
              </div>
            </div>
          </div>
        </div>
