...
<html lang="es">
	<head>
		...
		<title>Test 4 - Canal de Aprendizaje de Preferencia</title>
		<!-- Bootstrap CSS -->
									...
									<table width="100%" name="aprendizaje" class="table table-striped table-bordered table-hover">
										...
										<tbody>
											<tr class="odd" id="row_0">
												<td>		
													1. ¿Te resulta difícil mantener la atención, concentración, memoria y entender las instrucciones 	en los trabajos que realizas?							
												</td>
												<td>
											...
											<tr class="odd" id="row_0">
												<td>
													2.	¿Normalmente tienes pensamientos negativos y recurrentes de que algo malo va a pasar?
												</td>
												<td>
											...
											<tr class="odd" id="row_0">
												<td>
												3. ¿Te cuesta trabajo hacer amistades? 			
												</td>
												<td>
											...
											<tr class="odd" id="row_0">
												<td>
													4. ¿Te cuesta empezar algo y concluirlo?		
												</td>
												<td>
											...
											<tr class="odd" id="row_0">
												<td>
													5. ¿Tienes alteraciones en la lectura y escritura como mala ortografía, cambiar las palabras y/o letras, o agregar/quitar letras en lo que escribes?
												</td>
												<td>
											...
											<tr class="odd" id="row_0">
												<td>
													6. ¿Sueles padecer algunos de estos síntomas: opresión en el pecho, corazón acelerado, temblor, sudoración, problemas en el estómago? 			
												</td>
												<td>
											...
											<tr class="odd" id="row_0">
												<td>
													7. ¿Prefieres mantenerte aislado del resto de tus compañeros?  			
												</td>
												<td>
											...
											<tr class="odd" id="row_0">
												<td>
													8. ¿Tienes claridad de tus metas, de lo que quieres cumplir y lograr?		
												</td>
												<td>
											...
											<tr class="odd" id="row_0">
												<td>
													9. ¿Te cuesta trabajo entender las operaciones básicas de matemáticas como sumar, restar, multiplicar y dividir? 			
												</td>
												<td>
											...
											<tr class="odd" id="row_0">
												<td>
													10. ¿Sueles padecer algunos de estos síntomas: sensación de vacío, miedo al abandono real o imaginario, dolor emocional intenso, emociones intensas como enojo, tristeza, miedo, autolesiones, conductas de riesgo como: atracones en comida, abuso de alcohol o drogas en exceso, gusto por la velocidad?
												</td>
												<td>
											...
											<tr class="odd" id="row_0">
												<td>
													11. ¿Prefieres pasar más tiempo a solas y con tus dispositivos electrónicos?
												</td>
												<td>
											...
											<tr class="odd" id="row_0">
												<td>
													12. ¿Tiendes a pensar en el futuro?			
												</td>
												<td>
											...
											<tr class="odd" id="row_0">
												<td>
													13. ¿Sueles tener movimientos excesivos en pies y manos, y además te cuesta mantenerte en un solo lugar; asimismo de que sueles hablar mucho?
												</td>
												<td>
											...
											<tr class="odd" id="row_0">
												<td>
													14. ¿Sueles padecer algunos de estos síntomas: sentimientos de tristeza, desesperanza, irritabilidad, cansancio y fatiga, sentimientos de odio y culpa, desmotivación, alteración en sueño y alimentación (comer o dormir de más o menos)?
											...
											<tr class="odd" id="row_0">
												<td>
													15. ¿Te pone nervioso o temeroso hablar con las personas?		
												</td>
												<td>
											...
											<tr class="odd" id="row_0">
												<td>
													16. ¿Conoces tus fortalezas y debilidades?	
												</td>
												<td>
											...
											<tr class="odd" id="row_0">
												<td>
													17. ¿Consideras que tienes una rutina establecida para estudiar buenos hábitos de estudio?
												</td>
												<td>
											...
											<tr class="odd" id="row_0">
												<td>
													18. ¿Has tenido momentos donde te desconoces y sientes que no eres tú, momentos donde escuchas voces, ves sombras o sientes que te persiguen?
												</td>
												<td>
											...
											<tr class="odd" id="row_0">
												<td>
													19. ¿Te es difícil expresarte de tus emociones como comunicarte verbalmente?		
												</td>
												<td>
											...
											<tr class="odd" id="row_0">
												<td>
													20. ¿Identificas tus gustos, intereses y motivaciones?
												</td>
												<td>
